    ...
    public class RunWorkflowItem
    {
        public ItemRunResult RunItem(int EmpID, String RunPayload)
        {
            ...
            try
            {
                ...
                if (user == null)
                {
                    return new ItemRunResult { ResultID = 5, ResultText = String.Format("{0} is already disabled in Active Directory.", emp.Username), TimeDone = DateTime.Now, RunPayload = jsonPL };
                }
